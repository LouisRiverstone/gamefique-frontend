                        ...
                        <div class="mt-4">
                            <ul>
                                <li
                                    v-for="(
                                        objective, i
                                    ) in class_plan.class_plan_objectives"
                                    :key="i"
                                    class="mt-2"
                                >
                                    <div class="row">
                                            ...
                                            >
                                                ...
                                                <div
                                                    @click="
                                                        remove(
                                                            i,
                                                            class_plan.class_plan_objectives
                                                        )
                                                    "
                                                    class="remove"
                                                >
                        ...
                        <div class="mt-4">
                            <ul>
                                <li
                                    v-for="(
                                        activity, i
                                    ) in class_plan.class_plan_activities"
                                    :key="i"
                                    class="mt-2"
                                >
                                    <div class="row">
                                            ...
                                            >
                                                ...
                                                <div
                                                    @click="
                                                        remove(
                                                            i,
                                                            class_plan.class_plan_activities
                                                        )
                                                    "
                                                    class="remove"
                                                >
                        ...
                        <div class="mt-4">
                            <ul>
                                <li
                                    v-for="(
                                        strategy, i
                                    ) in class_plan.class_plan_strategies"
                                    :key="i"
                                    class="mt-2"
                                >
                                    <div class="row">
                                            ...
                                            >
                                                ...
                                                <div
                                                    @click="
                                                        remove(
                                                            i,
                                                            class_plan.class_plan_strategies
                                                        )
                                                    "
                                                    class="remove"
                                                >
                        ...
                        <div class="mt-4">
                            <ul>
                                <li
                                    v-for="(
                                        resource, i
                                    ) in class_plan.class_plan_resources"
                                    :key="i"
                                    class="mt-2"
                                >
                                    <div class="row">
                                            ...
                                            >
                                                ...
                                                <div
                                                    @click="
                                                        remove(
                                                            i,
                                                            class_plan.class_plan_resources
                                                        )
                                                    "
                                                    class="remove"
                                                >
...
export default defineComponent({
    ...
    methods: {
        insertObjective(data: ClassPlanDescriptionInterface) {
            this.class_plan.class_plan_objectives.push(data);
        },
        insertActivity(data: ClassPlanDescriptionInterface) {
            this.class_plan.class_plan_activities.push(data);
        },
        insertStrategy(data: ClassPlanDescriptionInterface) {
            this.class_plan.class_plan_strategies.push(data);
        },
        insertResource(data: ClassPlanDescriptionInterface) {
            this.class_plan.class_plan_resources.push(data);
        },
