  ...
  <div class="container mb-5">
    <div class="row post">
      <div class="col-sm-12 col-md-12 col-lg-8 card-post">
        <div class="mt-3">
          <!-- mobile -->
          <div class="d-none d-xs-block d-sm-block d-md-block d-lg-none mb-4">
            <div class="row mb-3">
              <div class="d-flex ms-4">
                <div class="me-4">
                  <Photo :photo="post.user.photo" class="rounded microphoto" />
                </div>
                <div class="">
                  <div
                ...
                <div class="row me-2 ms-2 mb-4">
                  <div class="col">
                    <div class="d-flex justify-content-start mt-3">
                      <p class="ms-2 like">
                        {{ post.like.length }}
                        {{ `${post.like.length > 1 ? "Gostaram" : "Gostou"}` }}
                        Dessa Aula
                      </p>
                    </div>
                  </div>
      ...
      <div
        class="col-sm-12 col-md-12 col-lg-3 offset-lg-1 card-post card-lateral"
      >
        <div class="d-none d-lg-block card-lateral">
          <div class="container mt-3">
            ...
            <div class="row mt-3 pb-5">
              ...
              >
              <span class="subs"> {{ post.user.formation_courses.name }}</span>
              <span class="subs">
